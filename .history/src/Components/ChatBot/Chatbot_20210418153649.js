    ...
    return (
      ...
      <ChatBot 
        ...
        steps={[
          ...
          {
            id: '3',
            message: `Hi {previousValue}! How can I help you? ${vari} To get updated price of our product list,  Press --> 1 ${vari} To get our discounted product list  Press --> 2 ${vari} To contact us about our product, Press --> 3`,
            trigger: 'gender',
          },
          {
            id: 'gender',
