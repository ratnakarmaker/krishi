    ...
    return (
      ...
      <ChatBot 
        ...
        steps={[
          ...
          {
            id: '7.1.1',
            message: "Potato per kg 30tk, order from our online store",
            trigger: "option"
          },
          {
            id: '7.1.2',
            message: "Rice per kg 60tk, order from our online store",
            trigger: "option"
          },
          {
            id: '7.1.3',
            message: "Tomato per kg 35tk, order from our online store",
            trigger: "option"
          },
          ...
          {
            id: "9.4.1.2.1",
            message: "Our HR team will contact you soon based on your quaries",
            trigger: "9.4.1.4"
          },
          {
            id: "9.4.1.4",
