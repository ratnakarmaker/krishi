      ...
      <ChatBot 
        ...
        steps={[
          ...
          },
          {
            id: 'gender',
            options: [
              { value: 'Potato - 10tk, Tomato - 30tk', label: 'Updated Price', trigger: 'gender' },
              { value: 'Capcicum - 45tk, Onion - 25tk', label: 'Discounted Products', trigger: 'gender' },
              { value: 'SElevent IT', label: 'Emergency Contact', trigger: 'gender' },
