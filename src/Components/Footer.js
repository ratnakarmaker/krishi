            ...
            <div className="footer__container bd-grid  bd-container">
                ...
                <div data-aos="fade-up" className="footer__content footer_icon">
                    ...
                    <ul className="footer-address">
                        ...
                        <li className="footer_icon pt-2"><i className="fas fa-phone-volume"></i> +880-1947179930</li>
                        <li className="pt-2"><i className="far fa-envelope "></i> support@selevenit.com</li>
                    </ul>
                </div>
            </div>
           <p className="footer__copy">&#169; {(new Date().getFullYear())} Arrot Krishi Ponno Ltd. All right reserved  ll Powered by SEleven IT Ltd.</p>
