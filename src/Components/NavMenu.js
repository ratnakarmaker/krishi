    ...
    return (
        <div className="container"> 
            <Navbar expand="lg" fixed="top" className="nav_bg">
                <Navbar.Brand href="/arrot"><a className="navbar-brand" href="/arrot"><img src={logo} alt="" class="img-fluid"/></a></Navbar.Brand>
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                <Navbar.Collapse id="basic-navbar-nav"  className="justify-content-end nav_menu1">
                    <Nav>
                        <Nav.Link href="#home" className="nav__link"><Link className="link active-link" to="/arrot">Home</Link></Nav.Link>
                        ...
                        <Nav.Link href="#home" className="nav__link"><Link className="link" to="/dashboard"></Link></Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
        </div>
