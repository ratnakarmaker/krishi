    ...
    return (
        ...
        <div class="ab_contact__container bd-grid pt-5">
            <div class="contact__data">
                ...
                <p class="contact__description">If you want to buy products from our website, you have to Registration first then login and buy your favourite goods.</p>
            </div>
...
export default BecomeBuyerAbout;